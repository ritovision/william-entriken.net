...
const SUCCESS_TITLE = 'Success. Message sent (yellow checkmark)';
const SUCCESS_TEXT = 'We will get back to you as soon as we can.';
const FAILURE_TITLE = 'Message not sent (red x emoji)';
...
const renderModalContent = (
  ...
  if (mode === 'success') {
    refs.title.textContent = SUCCESS_TITLE;
  ...
  if (mode === 'failure') {
    refs.title.textContent = FAILURE_TITLE;
